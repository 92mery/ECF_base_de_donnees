...
--
-- Hôte : localhost:8889
-- Généré le :  mer. 21 oct. 2020 à 18:03
...
CREATE TABLE `developpeurs` (
  ...
  `Apprentissage_1` varchar(100) NOT NULL,
  `Apprentissage_2` varchar(100) NOT NULL,
  `Apprentissage_3` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `developpeurs` (`id_dev`, `nom`, `prenom`, `date_naissance`, `date_entree`, `matricule`, `techno_predilection`, `Apprentissage_1`, `Apprentissage_2`, `Apprentissage_3`) VALUES
(1, 'Martin', 'Pierre', '2007-11-14', '2019-01-10', 20, 'React', 'Java', 'PHP', ''),
(2, 'Dupond', 'Paul', '2000-01-11', '2019-03-10', 43, 'Vue.js', 'Java', 'React', 'Angular'),
